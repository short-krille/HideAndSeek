...
public final class AssistantBridge {
    ...
    public static void shootProjectile(Plugin plugin, LivingEntity shooter, UUID assistantId, UUID targetId, UUID seekerId, String assistantSkin) {
        ...
        try {
            ...
            spawn.invoke(null, plugin, shooter, assistantId, launchLoc, initialVelocity, gravity, homing, homingRange, lifetime, targetId, seekerId, assistantSkin);
            return;
        } catch (Throwable ignored) {
        }
